...
public class Fist extends Projectile{
    public Fist(int ID, Character creator, double power, float hSPD, float vSPD, float xLocation, float yLocation, float width, float height, String effect, double direction)
    {
